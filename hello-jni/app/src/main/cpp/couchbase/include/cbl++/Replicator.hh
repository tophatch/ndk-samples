...
public:
    ...
    {
        _ref = CBLEndpoint_CreateWithLocalDB(db.ref());
    }
#endif
    ~Endpoint()
    {
        CBLEndpoint_Free(_ref);
    }
    CBLEndpoint* ref() const
    {
        return _ref;
    }
...
public:
    ...
    {
        CBLReplicator_Start(ref(), resetCheckpoint);
    }
    void stop()
    {
        CBLReplicator_Stop(ref());
    }

    void setHostReachable(bool r)
    {
        CBLReplicator_SetHostReachable(ref(), r);
    }
    void setSuspended(bool s)
    {
        CBLReplicator_SetSuspended(ref(), s);
    }

    CBLReplicatorStatus status() const
    {
        return CBLReplicator_Status(ref());
    }
    ...
    using DocumentListener = cbl::ListenerToken<Replicator, bool, const std::vector<CBLReplicatedDocument>>;
